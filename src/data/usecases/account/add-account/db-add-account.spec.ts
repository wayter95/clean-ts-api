...
import { Hasher, AddAccountParams, AccountModel, AddAccounRepository ,LoadAccountByEmailRepository } from './db-add-account-protocols'
...
const makeFakeAccounData = (): AddAccountParams => ({
  name: 'valid_name',
